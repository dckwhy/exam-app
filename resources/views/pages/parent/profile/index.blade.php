                ...
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9 text-secondary">
                                <ul class="list-group">
                                    @forelse ($user->oldster->childs()->get() as $data)
                                    <li class="list-group-item">{{ $data->user->name }} - {{ $data->school_origin }}
                                    </li>
                                    @empty
                                    <li class="list-group-item">No Child Data</li>
                                    @endforelse
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 d-flex justify-content-end">
                                <button type="button" class="btn btn-warning" id="updateProfile"
                                    value="{{ $user->oldster->id }}"><i class="fa fa-pencil"></i> Ubah</button>
                            </div>
                        </div>
                    </div>
                </div>
...
@includeIf('pages.parent.profile.modal')
@endsection
@push('js')
<script>
